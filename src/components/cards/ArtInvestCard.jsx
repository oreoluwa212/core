...
const ArtInvestCard = ({ imageSrc, title, description }) => {
  return (
    <div className="flex flex-row items-center gap-6 bg-[#1E1E1E] h-fit shadow-custom-blur backdrop-blur-sm lgss:w-[20%] lgsx:w-[30%] w-full pr-6 lgss:pr-6">
